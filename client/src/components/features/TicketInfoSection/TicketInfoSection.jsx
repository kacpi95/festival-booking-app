import styles from './TicketInfoSection.module.scss';
      ...
      <div className={styles.infoGrid}>
        <article className={`${styles.infoCard} ${styles.infoLarge}`}>
          ...
          <div className={styles.infoContent}>
            ...
            <p className={styles.infoText}>
              All standard tickets include access to the general standing area.
              VIP upgrades and selected reserved zones may be available during
              checkout depending on ticket type.
            </p>
          </div>
        </article>
        ...
        <div className={styles.infoSide}>
          ...
          <div className={styles.infoMiniGrid}>
            <article className={`${styles.infoCard} ${styles.infoAccentPink}`}>
              <h3 className={styles.infoTitle}>Easy Refund</h3>
              <p className={styles.infoText}>
                Cancellation requests can be submitted up to 14 days before the
                event for eligible ticket types.
              </p>
            </article>

            <article className={`${styles.infoCard} ${styles.infoAccentCyan}`}>
